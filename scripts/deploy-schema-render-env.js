 ...
 * This script uses the exact connection details from the Render service
 */

import { Client } from 'pg';

// Use the exact connection details from Render
const databaseUrl = 'postgresql://shared_wealth_db_user:fQ36Pb3VRDUHD6UsiqmeLCNG0KLXtYSd@dpg-d3ballbe5dus73cddqs0-a.oregon-postgres.render.com:5432/shared_wealth_db';
