 ...
 * This script uses the DATABASE_URL environment variable for connection
 */
...
const databaseUrl = process.env.DATABASE_URL || 
  `postgresql://${process.env.DB_USER || 'shared_wealth_db_user'}:${process.env.DB_PASSWORD || 'default_password'}@${process.env.DB_HOST || 'dpg-d3ballbe5dus73cddqs0-a.oregon-postgres.render.com'}:${process.env.DB_PORT || 5432}/${process.env.DB_NAME || 'shared_wealth_db'}`;
