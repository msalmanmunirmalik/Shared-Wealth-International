-- Sample Data Population Script for Phase 1
...
INSERT INTO user_companies (user_id, company_id, role, position, status, is_primary) VALUES
('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'owner', 'CEO', 'active', true),
('22222222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'owner', 'Founder & CTO', 'active', true),
('33333333-3333-3333-3333-333333333333', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'owner', 'Managing Partner', 'active', true),
('44444444-4444-4444-4444-444444444444', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'owner', 'President & CEO', 'active', true),
('55555555-5555-5555-5555-555555555555', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'owner', 'Co-Founder & COO', 'active', true),
('66666666-6666-6666-6666-666666666666', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'owner', 'Founder & CEO', 'active', true),
-- Add some additional relationships
('11111111-1111-1111-1111-111111111111', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'advisor', 'Technology Advisor', 'active', false),
('22222222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'investor', 'Board Member', 'active', false)
...
INSERT INTO forum_categories (id, name, description, order_index, is_active) VALUES
('catttttt-tttt-tttt-tttt-tttttttttttt', 'General Discussion', 'General topics and community discussions', 1, true),
('catttttt-tttt-tttt-tttt-tttttttttttu', 'Business & Strategy', 'Business development and strategic planning discussions', 2, true),
('catttttt-tttt-tttt-tttt-tttttttttttv', 'Technology', 'Technology and innovation topics', 3, true),
('catttttt-tttt-tttt-tttt-tttttttttttw', 'Sustainability', 'Environmental and sustainability discussions', 4, true),
('catttttt-tttt-tttt-tttt-tttttttttttx', 'Events & Networking', 'Event-related discussions and networking', 5, true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO events (id, title, description, event_type, location, virtual_link, start_date, end_date, capacity, registration_required, registration_url, status, created_by) VALUES
('evvvvvvv-vvvv-vvvv-vvvv-vvvvvvvvvvvv', 'Shared Wealth Principles Workshop', 'Learn about implementing shared wealth principles in your business', 'workshop', 'San Francisco, CA', NULL, '2024-02-15 09:00:00', '2024-02-15 17:00:00', 50, true, 'https://sharedwealth.com/workshop-feb15', 'upcoming', '11111111-1111-1111-1111-111111111111'),
('evvvvvvv-vvvv-vvvv-vvvv-vvvvvvvvvvvw', 'Sustainability in Tech: Online Panel', 'Panel discussion on sustainable technology practices', 'webinar', NULL, 'https://zoom.us/j/123456789', '2024-02-20 14:00:00', '2024-02-20 15:30:00', 200, true, 'https://sharedwealth.com/webinar-feb20', 'upcoming', '22222222-2222-2222-2222-222222222222'),
('evvvvvvv-vvvv-vvvv-vvvv-vvvvvvvvvvvx', 'Community Banking Innovation Summit', 'Annual summit for community banking innovation', 'conference', 'Portland, OR', NULL, '2024-03-10 08:00:00', '2024-03-12 18:00:00', 300, true, 'https://sharedwealth.com/summit-mar10', 'upcoming', '44444444-4444-4444-4444-444444444444')
ON CONFLICT (id) DO NOTHING;

-- Create sample activity feed entries
INSERT INTO activity_feed (id, user_id, activity_type, activity_data, is_read) VALUES
('actttttt-tttt-tttt-tttt-tttttttttttt', '11111111-1111-1111-1111-111111111111', 'company_joined', '{"company_name": "EcoTech Solutions", "action": "joined", "message": "EcoTech Solutions joined the Shared Wealth network"}', false),
('actttttt-tttt-tttt-tttt-tttttttttttu', '22222222-2222-2222-2222-222222222222', 'project_started', '{"project_name": "Solar Panel Installation Initiative", "action": "started", "message": "New collaboration project started"}', false),
('actttttt-tttt-tttt-tttt-tttttttttttv', '33333333-3333-3333-3333-333333333333', 'meeting_completed', '{"meeting_title": "Impact Investment Strategy Session", "action": "completed", "message": "Strategic meeting completed with positive outcomes"}', false),
('actttttt-tttt-tttt-tttt-tttttttttttw', '44444444-4444-4444-4444-444444444444', 'application_approved', '{"company_name": "HealthTech Community", "action": "approved", "message": "New company application approved"}', false),
('actttttt-tttt-tttt-tttt-tttttttttttx', '55555555-5555-5555-5555-555555555555', 'forum_post', '{"post_title": "Sustainable Business Models That Work", "action": "posted", "message": "New forum discussion started"}', false)
ON CONFLICT (id) DO NOTHING;
