-- Simple Sample Data Population Script
...
INSERT INTO companies (id, name, description, industry, sector, size, location, website, logo_url, employees, status, is_shared_wealth_licensed, license_number, license_date, applicant_role, applicant_position, applicant_user_id, created_by_admin) VALUES
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'EcoTech Solutions', 'Leading provider of sustainable technology solutions for businesses', 'Technology', 'Green Tech', 'medium', 'San Francisco, CA', 'https://ecotech-solutions.com', '/logos/ecotech.png', 150, 'approved', true, 'SWL-2024-001', '2024-01-15', 'CEO', 'Chief Executive Officer', '11111111-1111-1111-1111-111111111111', false),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'GreenEnergy Corp', 'Renewable energy solutions and sustainable power systems', 'Energy', 'Renewable Energy', 'large', 'Austin, TX', 'https://greenenergy-corp.com', '/logos/greenenergy.png', 500, 'approved', true, 'SWL-2024-002', '2024-02-01', 'Founder', 'Founder & CTO', '22222222-2222-2222-2222-222222222222', false),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'SocialImpact Ventures', 'Investment firm focused on social impact and shared wealth businesses', 'Finance', 'Impact Investing', 'medium', 'New York, NY', 'https://socialimpact-ventures.com', '/logos/socialimpact.png', 75, 'approved', true, 'SWL-2024-003', '2024-02-15', 'Managing Partner', 'Managing Partner', '33333333-3333-3333-3333-333333333333', false),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'CommunityFirst Bank', 'Community-focused banking with shared wealth principles', 'Finance', 'Community Banking', 'large', 'Portland, OR', 'https://communityfirst-bank.com', '/logos/communityfirst.png', 300, 'approved', true, 'SWL-2024-004', '2024-03-01', 'President', 'President & CEO', '44444444-4444-4444-4444-444444444444', false),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Sustainable Foods Co', 'Organic and sustainable food production and distribution', 'Agriculture', 'Sustainable Agriculture', 'medium', 'Seattle, WA', 'https://sustainable-foods.com', '/logos/sustainablefoods.png', 200, 'approved', true, 'SWL-2024-005', '2024-03-15', 'Co-Founder', 'Co-Founder & COO', '55555555-5555-5555-5555-555555555555', false),
('ffffffff-ffff-ffff-ffff-ffffffffffff', 'TechForGood Inc', 'Technology solutions for social good and community development', 'Technology', 'Social Tech', 'small', 'Denver, CO', 'https://techforgood-inc.com', '/logos/techforgood.png', 25, 'pending', false, NULL, NULL, 'Founder', 'Founder & CEO', '66666666-6666-6666-6666-666666666666', false)
...
INSERT INTO forum_topics (id, category_id, title, content, user_id, is_pinned, is_locked, view_count, reply_count, last_reply_at) VALUES
...
INSERT INTO forum_replies (id, topic_id, content, user_id, is_solution) VALUES
...
INSERT INTO events (id, title, description, location, start_date, end_date, capacity, registration_required, registration_url, status, created_by) VALUES
('evvvvvvv-vvvv-vvvv-vvvv-vvvvvvvvvvvv', 'Shared Wealth Principles Workshop', 'Learn about implementing shared wealth principles in your business', 'San Francisco, CA', '2024-02-15 09:00:00', '2024-02-15 17:00:00', 50, true, 'https://sharedwealth.com/workshop-feb15', 'upcoming', '11111111-1111-1111-1111-111111111111'),
('evvvvvvv-vvvv-vvvv-vvvv-vvvvvvvvvvvw', 'Sustainability in Tech: Online Panel', 'Panel discussion on sustainable technology practices', 'Online', '2024-02-20 14:00:00', '2024-02-20 15:30:00', 200, true, 'https://sharedwealth.com/webinar-feb20', 'upcoming', '22222222-2222-2222-2222-222222222222'),
('evvvvvvv-vvvv-vvvv-vvvv-vvvvvvvvvvvx', 'Community Banking Innovation Summit', 'Annual summit for community banking innovation', 'Portland, OR', '2024-03-10 08:00:00', '2024-03-12 18:00:00', 300, true, 'https://sharedwealth.com/summit-mar10', 'upcoming', '44444444-4444-4444-4444-444444444444')
ON CONFLICT (id) DO NOTHING;
