...
const fileFilter = (req, file, cb) => {
    const uploadType = req.body.uploadType || 'general';
    const allowedTypes = allowedMimeTypes[uploadType] || allowedMimeTypes.general;
...
export const uploadLogo = multer({
    ...
    fileFilter: (req, file, cb) => {
        if (allowedMimeTypes.logos.includes(file.mimetype)) {
            ...
            cb(new Error('Only JPEG, PNG, and SVG files are allowed for logos'), false);
        }
    },
    limits: {
...
export const validateFile = (file, uploadType = 'general') => {
    const allowedTypes = allowedMimeTypes[uploadType] || allowedMimeTypes.general;
    const maxSize = maxFileSizes[uploadType] || maxFileSizes.general;
    if (!allowedTypes.includes(file.mimetype)) {
